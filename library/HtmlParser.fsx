...
val results: HtmlDocument =
  <!-- html>--><html lang="en">
  <head>
    <meta charset="UTF-8" /><meta content="/images/branding/googleg/1x/googleg_standard_color_128dp.png" itemprop="image" /><title>FSharp.Data - Google Search</title><script nonce="te1pqtHeRngO3HXzNMI-cg">(function(){
...
val links: (string * string) list =
  [("Google", "/?sa=X&ved=0ahUKEwin49nt4cSCAxVLPUQIHRAaBA8QOwgC");
   ("here",
    "/search?q=FSharp.Data&sca_esv=582466614&ie=UTF-8&gbv=1&sei=6x"+[20 chars]);
   ("Videos",
    "/search?q=FSharp.Data&sca_esv=582466614&ie=UTF-8&tbm=vid&sour"+[58 chars]);
   ("Images",
    "/search?q=FSharp.Data&sca_esv=582466614&ie=UTF-8&tbm=isch&sou"+[59 chars]);
   ("News",
    "/search?q=FSharp.Data&sca_esv=582466614&ie=UTF-8&tbm=nws&sour"+[58 chars]);
   ("Maps",
    "http://maps.google.co.uk/maps?q=FSharp.Data&um=1&ie=UTF-8&sa="+[47 chars]);
   ("Shopping",
    "/search?q=FSharp.Data&sca_esv=582466614&ie=UTF-8&tbm=shop&sou"+[59 chars]);
   ("Books",
    "/search?q=FSharp.Data&sca_esv=582466614&ie=UTF-8&tbm=bks&sour"+[58 chars]);
