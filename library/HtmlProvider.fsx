...
Race, round "Source:[75]" is hosted at "Source:[75]" on "Source:[75]"
val f1Calendar: HtmlProvider<...>.SeasonCalendaredit
val firstRow: HtmlProvider<...>.SeasonCalendaredit.Row =
...
val stats: (string * decimal) array =
  [|("6.3", 31407M); ("6.2", 69923M); ("6.1", 1570M); ("6.0", 10495M);
    ("5.0", 287322M); ("4.2", 659521M); ("4.1", 163385M); ("4.0", 99937M);
    ("3.3", 1081611M); ("3.2", 45326M); ("3.1", 242504M); ("3.0", 526068M);
    ("2.4", 459304M); ("2.3", 571288M); ("2.2", 329432M); ("2.1", 36462M);
    ("2.0", 124428M); ("1.1", 103537M); ("1.0", 51493M)|]*)
(**
