...
val doc: HtmlDocument =
  <!-- html>--><html lang="en">
  <head>
    <meta charset="UTF-8" /><meta content="/images/branding/googleg/1x/googleg_standard_color_128dp.png" itemprop="image" /><title>FSharp.Data - Google Search</title><script nonce="ttmDSXm7HmfSX2YJJBKilw">(function(){
...
val doc2: HtmlDocument =
  <!-- html>--><html lang="en">
  <head>
    <meta charset="UTF-8" /><meta content="/images/branding/googleg/1x/googleg_standard_color_128dp.png" itemprop="image" /><title>F# - Google Search</title><script nonce="z4QYw1D2FCoy0k5jCNr5TQ">(function(){
...
let englishLinks = englishDoc.CssSelect("a[hreflang|=en]")(* output: 
...
let manElems = manDoc.CssSelect("input[name*='man']")(* output: 
...
*)
let manWordElems = manDoc.CssSelect("input[name~='man']")(* output: 
...
*)
let manEndElemes = manDoc.CssSelect("input[name$='man']")(* output: 
...
*)
let manEqElemes = manDoc.CssSelect("input[name='man']")(* output: 
...
*)
let notManElems = manDoc.CssSelect("input[name!='man']")(* output: 
...
*)
let manStartElems = manDoc.CssSelect("input[name^='man']")(* output: 
